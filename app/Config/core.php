 ...
 */
	...
	Configure::write('Security.salt', 'Hjkofgrtyshjlnvgfyrtsjutydcbpwetyrvbncsdewrfghty');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	//Configure::write('Security.cipherSeed', '76859309657453542496749683645');
	Configure::write('Security.cipherSeed', '4654796543165494854897645123659845215849532154');
