   			...
   			if(!empty($mediaItems))
			{
				foreach($mediaItems as $k=>$v)
				{
			      ...
			      <div class="media-item" id="media-item-<?php echo $v['id']; ?>">
			      	<a href="#" onclick="insert_url('<?php echo $uploadDir.'plugins/uploader/'.$v['path'] ?>')" class="image_cke">
			      		<img src="<?php echo $uploadDir.'plugins/uploader/'.$v['path'] ?>" class="media-item-image" />
			      	</a>
